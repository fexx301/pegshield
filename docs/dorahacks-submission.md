...
• Atomic two-proof claim + 100 tUSD payout on CC3 — receipt-linked below
• Source events: Ethereum rounds 1171/1172, inclusion-proven via Attestcoin
• Fresh v4 deployment (2026-09-11) with an active policy — current-dated
evidence chain, schema-validated manifest
• Underwriter-funded pool with exact reserve accounting, premiums, expiry
